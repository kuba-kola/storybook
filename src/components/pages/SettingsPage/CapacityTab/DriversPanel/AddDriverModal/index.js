  ...
  return (
    ...
    >
      <div className="capacitySettingsEditDriverModalStatusContainer">
        {showSuccess && (
        <div
          className="capacitySettingsEditDriverModalStatusBar capacitySettingsEditDriverModalStatusBarSuccess"
        ...
        {showError && (
        <div
          className="capacitySettingsEditDriverModalStatusBar capacitySettingsEditDriverModalStatusBarError"
